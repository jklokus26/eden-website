...
<p>This case demonstrates how mission-aligned, media-savvy storytelling can turn protocol-layer technology into mainstream relevance.</p>`,
  ...
  },
  {
    ...
    date: 'March 5, 2026',
    service: 'PR Strategy',
    description: "Eden's campaign created a category leader in the refrigerated shipping sector",
    heroImage: '/assets/images/grip-shipping-team.jpg',
...
<li>Establish thought leadership in perishable eCommerce logistics</li>
<li>Attract the attention of potential investors and partners</li>
...
<p>This case demonstrates how strategic public relations can accelerate growth for innovative companies ready to claim their market position.</p>`,
  ...
  {
    slug: 'franzy',
    title: 'Case Study: Franzy',
    subtitle: 'A launch campaign put this AI-driven franchising startup on the map',
    date: 'March 5, 2026',
    service: 'Launch Campaign',
    description: 'A launch campaign put this AI-driven franchising startup on the map',
    heroImage: '/assets/images/franzy-fox-business.jpg',
...
<li>Educate the public on franchising as a legitimate path to business ownership</li>
<li>Replace traditional franchise brokers who dominate the category</li>
<li>Launch publicly with national credibility and momentum</li>
<li>Generate qualified leads from high-intent prospective franchisees</li>
</ul>
