...
const EDEN_LOGO_SVG = `<svg viewBox="0 0 105 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="loader-logo" aria-label="Eden Communications">
...
export function initLoader() {
  ...
  const barFill = loaderEl.querySelector('.loader-bar-fill');
  ...
  // Fallback: dismiss after 3s in case window.load already fired
  setTimeout(() => {
